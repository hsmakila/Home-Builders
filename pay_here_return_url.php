...
$sql = "UPDATE `job` SET job_advance_paid=?, job_status=? WHERE job_id=?";
$stmt = $conn->prepare($sql);
$stmt->execute([$pay_amount, 'scheduled', $order_id]);
                    ...
                    <tr align="left">
                        ...
                        <td
                            ...
                            <p
                                ...
                                Amount:
                                <?php echo number_format($pay_amount, 2) . " LKR" ?> <br />
                                JOB ID:
                                <?php echo $order_details["job_id"] ?><br />
                            </p>
                            <br>
                            <p
                                style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;">
            ...
            <tr>
                <td align="center"
                    ...
                    <p class="text-white"
                        ...
                        Copyright © GO p.l.c. 2018. All rights reserved.</p>
